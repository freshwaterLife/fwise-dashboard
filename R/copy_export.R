...
FW_COPY_EXPORT <- list(
  ...
  export = list(
    ...
    dictionary = c(
      ...
      labour_person_days  = "Effort required, person-days.",
      cost_estimate       = "Estimated cost, where recorded.",
      cost_currency       = "Currency of cost_estimate.",
      toxin_conc_mg_l     = "Target toxin concentration, mg/L. Chemical methods only.",
